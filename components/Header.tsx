...
import { Menu, X, ChevronDown, LogIn, Box, Coffee, FileText, ShoppingBag, Sparkles, Utensils } from "lucide-react";
    ...
    <header className="w-full py-3 px-4 sm:px-6 lg:px-8 border-b border-border bg-white sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-3">
          ...
          >
            <button className="flex items-center gap-1 text-ink-muted hover:text-ink transition-colors text-sm font-medium py-2">
              Shop
              ...
              <div className="absolute top-full left-1/2 -translate-x-1/2 pt-2 z-50">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <Link
                    ...
                    className="flex flex-col rounded-lg hover:shadow-lg border-2 border-transparent hover:border-brand-orange transition-all group overflow-hidden"
                  >
