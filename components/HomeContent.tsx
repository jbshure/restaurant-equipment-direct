          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center space-y-5">
              ...
              <p className="text-lg sm:text-xl text-ink-muted max-w-2xl mx-auto leading-snug">
                Commercial kitchen equipment and smallwares at wholesale prices. <span className="font-handwritten text-2xl" style={{ color: '#FF8556' }}>No middleman, no markup.</span>
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
                <Link
                  href="/shop"
                  className="group px-8 py-4 bg-brand-orange text-white font-heading font-semibold text-lg rounded-lg hover:bg-brand-orange-dark transition-all shadow-lg hover:shadow-xl border-2 border-brand-orange-dark"
                >
                  Browse Catalog
