  ...
  return (
    <>
      ...
      >
        ...
        {/* Lead Gen CTA Block */}
        <div className="bg-gradient-to-br from-green-50 to-bg p-8 sm:p-12 rounded-2xl border-2 border-green-500 mb-12 shadow-sm">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/contact"
                className="px-8 py-4 bg-green-600 text-white font-heading font-semibold text-lg rounded-lg hover:bg-green-700 transition-colors shadow-md hover:shadow-lg"
              >
                Request Quote
              </Link>
              <Link
                href="/custom-printing"
                className="px-8 py-4 bg-white text-ink font-heading font-semibold text-lg rounded-lg hover:bg-gray-50 transition-colors border-2 border-gray-300 hover:border-green-500"
              >
