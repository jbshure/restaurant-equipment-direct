...
export default function TakeoutContainersPage() {
  return (
    ...
    >
      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {products.map((product, index) => (
            <div key={index} className="p-6 bg-white border-2 border-border rounded-xl hover:border-brand-orange transition-all">
      ...
      {/* Lead Gen CTA Block */}
      <div className="bg-gradient-to-br from-orange-50 to-bg p-8 sm:p-12 rounded-2xl border-2 border-brand-orange mb-12 shadow-sm">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="px-8 py-4 bg-brand-orange text-white font-heading font-semibold text-lg rounded-lg hover:bg-brand-orange-dark transition-colors shadow-md hover:shadow-lg"
            >
              Request Quote
            </Link>
            <Link
              href="/custom-printing"
              className="px-8 py-4 bg-white text-ink font-heading font-semibold text-lg rounded-lg hover:bg-gray-50 transition-colors border-2 border-gray-300 hover:border-brand-orange"
            >
              Custom Printing
            </Link>
          </div>
