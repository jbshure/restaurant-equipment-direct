      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-sm max-w-none text-ink-muted space-y-6">
            ...
            <section>
              <h2 className="text-2xl font-heading font-bold text-orange-600 mb-3">Information We Collect</h2>
            ...
            <section>
              <h2 className="text-2xl font-heading font-bold text-orange-600 mb-3">How We Use Your Information</h2>
            ...
            <section>
              <h2 className="text-2xl font-heading font-bold text-orange-600 mb-3">Information Sharing</h2>
            ...
            <section>
              <h2 className="text-2xl font-heading font-bold text-orange-600 mb-3">Cookies and Tracking</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-heading font-bold text-orange-600 mb-3">Data Security</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-heading font-bold text-orange-600 mb-3">Your Rights</h2>
            ...
            <section>
              <h2 className="text-2xl font-heading font-bold text-orange-600 mb-3">Children's Privacy</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-heading font-bold text-orange-600 mb-3">Changes to This Policy</h2>
              <p>
