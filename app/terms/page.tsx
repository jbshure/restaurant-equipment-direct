      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-sm max-w-none text-ink-muted space-y-6">
            ...
            <section>
              <h2 className="text-2xl font-heading font-bold text-orange-600 mb-3">Use of Services</h2>
            ...
            <section>
              <h2 className="text-2xl font-heading font-bold text-orange-600 mb-3">Account Registration</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-heading font-bold text-orange-600 mb-3">Payment Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-heading font-bold text-orange-600 mb-3">Shipping and Delivery</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-heading font-bold text-orange-600 mb-3">Returns and Refunds</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-2xl font-heading font-bold text-orange-600 mb-3">Disclaimers</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-2xl font-heading font-bold text-orange-600 mb-3">Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-heading font-bold text-orange-600 mb-3">Dispute Resolution</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-heading font-bold text-orange-600 mb-3">Governing Law</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-heading font-bold text-orange-600 mb-3">Changes to Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-heading font-bold text-orange-600 mb-3">Severability</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-heading font-bold text-orange-600 mb-3">Contact Us</h2>
              <p className="mb-3">
